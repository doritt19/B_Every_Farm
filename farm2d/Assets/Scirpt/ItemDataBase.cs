...
public class ItemDataBase : MonoBehaviour
{
    ...
    public void AddList()
    {
            ...
            //itemDB.Clear();
            AddItemToDB(1, "Carrot", ShopScriptUI.SSU.loadedImage.Find(sprite => sprite.name== "Seed_carrot"), "이것은 당근이라고하는게 당근.", 500, ItemType.Seed, 99);
            AddItemToDB(2, "cabbage", ShopScriptUI.SSU.loadedImage[0], "양배추랑 양상추랑 헷갈리지 마유.", 800, ItemType.Seed, 99);        
            AddItemToDB(3, "Tomato", ShopScriptUI.SSU.loadedImage[0], "토마토는 거꾸로 해도 토마토.", 500, ItemType.Seed, 99);
            AddItemToDB(4, "Onion", ShopScriptUI.SSU.loadedImage[0], "이것은 까도까도 까이는 양파여.", 600, ItemType.Seed, 99);
            AddItemToDB(5, "Pumkin", ShopScriptUI.SSU.loadedImage.Find(sprite => sprite.name == "Seed_Pumkin"), "내 이름은 잭 오 랜턴. 그냥 호박이죠", 1000, ItemType.Seed, 99);
            AddItemToDB(1, "하우스", ShopScriptUI.SSU.loadedImage[0], "집이지만 비닐 하우스", 2000, ItemType.Building, 2);        
            ...
            AddItemToDB(2, "작은 땅", ShopScriptUI.SSU.loadedImage[3], "밭 싱글", 3000, ItemType.Field, 10);
